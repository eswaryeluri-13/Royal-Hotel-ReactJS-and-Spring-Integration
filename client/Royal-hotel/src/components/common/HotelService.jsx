			...
			<div className="mb-2">
				...
				<h4 className="text-center">
    				<span className="gap-2">
       				   <FaClock className="ml-5" style={{ marginLeft: '10px' }} /> Complimentary Services at <span className="hotel-color"> Royal - </span>Hotel 
    				</span>
				</h4>
				...
				<Row xs={1} md={2} lg={3} className="g-4 mt-2">
					...
					<Col>
						<Card>
							<Card.Body>
								<Card.Title className="hotel-color">
									<FaTshirt /> Airport Shuttle
								</Card.Title>
								<Card.Text>Complimentary airport shuttles add guest convenience during arrivals and departures.</Card.Text>
							</Card.Body>
						</Card>
					</Col>
					<Col>
					...
					<Col>
						<Card>
							<Card.Body>
								<Card.Title className="hotel-color">
									<FaSnowflake /> Centralized Air conditioning
								</Card.Title>
